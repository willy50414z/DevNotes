...
public class BookingGui
    ...
    /**
     * Callback method to handle data state change notification from the
     * suncertify model.
     *
    ...
    /**
     * This inner class implements ListSelectionListener and handles the
     * selection of JTable cell. Once a cell is selected, record is
     * automatically filled in the constractor panel.
     */
    public class ChooseRecord implements ListSelectionListener {
         ...
         * constractor panel. If successful, a choose record message shown in
         * status area. If failed, no message is shown.
         *
