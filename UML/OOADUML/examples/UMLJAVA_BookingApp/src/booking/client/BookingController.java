...
public class BookingController {
    ...
    /**
     * Create data user gesture callback method called by the suncertify view in
     * response to the create data button click on the GUI or equivalent user
     * interface action - create the data in the model
     *
    ...
    /**
     * Update data user gesture callback method called by the suncertify view in
     * response to the update data button click on the GUI or equivalent user
     * interface action - update the data in the model
     *
    ...
    /**
     * Delete data user gesture callback method called by the suncertify view in
     * response to the delete data button click on the GUI or equivalent user
     * interface action - delete the data in the model
     *
     * @param recNo Record number.
     */
