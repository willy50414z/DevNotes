...
public class Data implements DBMain, Serializable {
    ...
    /**
     * This constructor opens an existing database given the name of the disk
     * file containing it.
     *
    ...
    /**
     * Adds requestor to the list of objects to be notified when an object model
     * alters state.
     *
    ...
    /**
     * This method notifies all registered BookingView listeners that data has
     * changed.
     */
    ...
    /**
     * Closes the database, flushing any outstanding writes at the same time.
     */
     ...
     * @return String array for the record or null if the record has been marked
     * for deletion.
     * @exception RecordNotFoundException Thrown if database file cannot be
     * accessed.
     */
    ...
    /**
     * This method searches the database for match the specified criteria.
     *
     * @param criteria A null value in criteria[n] matches any field value. A
     * non-null value in criteria[n] matches any field value that begins with
     * criteria[n].
     * @return int array The matching record number.
     * @exception RecordNotFoundException Thrown when can not find any match
     * record.
     */
     ...
     * access file.
     *
     * @return The array of strings that make up a database record. Null value
     * if record is marked deleted.
     * @exception BookingException Generated if any unexpected exception occur.
     */
    ...
    /**
     * Writes a record to the database using the current location of the
     ...
     *
     * @param recNo The record number.
     * @return The Boolean value, true mean record is valid, false mean record
     * is deleted.
     * @exception BookingException generated if any unexpected exception occur.
     */
